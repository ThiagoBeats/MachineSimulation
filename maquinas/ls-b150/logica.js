// ---------------------------------------------------------------------------
// LOGICA DO CLP DA LS-B150 EMULADA EM JAVASCRIPT
//
// O CLP da B150 e da mesma familia do da LS-B130 - mesmos POUs, mesmos nomes
// de simbolo - entao este arquivo e igual ao da B130. Se as duas maquinas
// divergirem no futuro, cada uma segue com a sua copia.
//
...
(function (raiz, fabrica) {
  ...
  // Chamado uma vez no arranque, antes do primeiro cliente.
  function arrancar() {
    listasDeProdutos();
  }

  return { configurar, ciclo, arrancar, listasDeProdutos };
});
