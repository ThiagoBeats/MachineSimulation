...
(function (/** @type {globalThis.TcHmi} */ TcHmi) {
    ...
    (function (/** @type {globalThis.TcHmi.Functions} */ Functions) {
        ...
        (function (HMI_TRATADORA_B300) {
            function PopUpRecipeSave(RecipeName) {

                    let loc = TcHmi.Functions.Beckhoff;
                    var RecipeName = null;
                    
                    TcHmi.Symbol.readEx2('%s%PLC1.Recipes.InterfaceRecipe.RecipeName%/s%', RecipeName);
            ...
            HMI_TRATADORA_B300.PopUpRecipeSave = PopUpRecipeSave;
        })(HMI_TRATADORA_B300 = Functions.HMI_TRATADORA_B300 || (Functions.HMI_TRATADORA_B300 = {}));
    })(Functions = TcHmi.Functions || (TcHmi.Functions = {}));
})(TcHmi);
TcHmi.Functions.registerFunctionEx('PopUpRecipeSave', 'TcHmi.Functions.HMI_TRATADORA_B300', TcHmi.Functions.HMI_TRATADORA_B300.PopUpRecipeSave);
